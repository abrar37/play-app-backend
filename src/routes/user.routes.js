...
router.route("/change-avatar").patch(varifyjwt, upload.single("avatar"), updateUserAvatar)
router.route("/chnage-cover-image").patch(varifyjwt, upload.single("coverImage"), updateCoverImage)
